...
public class ArithmeticOperatorController {
	...
	public String add(@RequestParam(value="op1",required=false) String op1, @RequestParam("op2") int op2, Model model){
	...
	public String divide(@RequestParam("op1") Integer op1, @RequestParam("op2") int op2, Model model){
		model.addAttribute("result", op1/op2);
		return "math/result";
	}
}
